...
type RandafEventMode struct {
	Trigger RandafEventTriggerAnyOf `json:"trigger"`
...
func NewRandafEventMode(trigger RandafEventTriggerAnyOf) *RandafEventMode {
...
func (o *RandafEventMode) GetTrigger() RandafEventTriggerAnyOf {
	if o == nil {
		var ret RandafEventTriggerAnyOf
		return ret
	}
...
func (o *RandafEventMode) GetTriggerOk() (*RandafEventTriggerAnyOf, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RandafEventMode) SetTrigger(v RandafEventTriggerAnyOf) {
	o.Trigger = v
}
