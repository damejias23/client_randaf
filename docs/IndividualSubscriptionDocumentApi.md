...
------------- | ------------- | -------------
[**DeleteSubscription**](IndividualSubscriptionDocumentApi.md#DeleteSubscription) | **Delete** /subscriptions/{subscriptionId} | Nrandaf_EventExposure Unsubscribe service Operation
...
Nrandaf_EventExposure Unsubscribe service Operation
